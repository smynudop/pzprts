...
export const DbChocoPlayer = createPlayer(Lib.DoubleChoco)
...
export const ToichikaPlayer = createPlayer(Lib.Toichika)
export const BarnsPlayer = createPlayer(Lib.Barns)
export const ShugakuPlayer = createPlayer(Lib.Shugaku)
export const StarBattlePlayer = createPlayer(Lib.StarBattle)
export const ChoconaPlayer = createPlayer(Lib.Chocona)
export const StostonePlayer = createPlayer(Lib.Stostone)
export const ShimaguniPlayer = createPlayer(Lib.Shimaguni)